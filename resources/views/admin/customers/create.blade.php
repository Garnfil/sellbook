                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="contact_number" id="contact-number-field">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-4 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="int" class="form-control" name="age" id="age-field" readonly>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="zip_code" id="zip-code-field">
